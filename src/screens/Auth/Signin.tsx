...
// Service imports
import { signin } from '../../services/BasicAuthService';
...
const Signin = ({ navigation }: any) => {
    ...
    const emailTitle: string = "E-mail";
    const passwordTitle: string = "Password";
    const signInButtonTitle: string = "Connection!";
    const signUpButtonTitle: string = "Sign up!";
    ...
    const login = () => {
        signin(email, password).then((res) => {
            ...
            if (error) {
                ...
                if (error.includes('auth/invalid-email') || error.includes('auth/wrong-password')) {
                    setError(true);
                }
            }
        });
            ...
            <View style={styles.container}>
                ...
                <View style={styles.formContainer}>
                    ...
                    <View style={styles.button}>
                        <Button title={signInButtonTitle} color="#000" onPress={login} />
                    </View>
                    <Separator />
                    <View style={styles.button}>
                        <Button
